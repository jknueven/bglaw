                    ...
                    if(address != undefined && address[0] != ""){
                            geocoder.geocode( { 'address': address[0].replace('[nomarker]','')}, function(results, status) {
                                ...
                                address.forEach(function(address){
                                    ...
                                    markerImage = {url: window.mr_variant == undefined ? '_assets/img/mapmarker.png' : '.._assets/img/mapmarker.png', size: new google.maps.Size(50,50), scaledSize: new google.maps.Size(50,50)};
