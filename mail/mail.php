...
$outgoingServerAddress      = 'imap.gmail.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'webadmin@biesergreer.com';
$sendingAccountPassword     = 'p@55w0rd';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'ed@rainydaymedia.net'; // REQUIRED value.
$recipientName              = 'Bieser Greer Website';             // REQUIRED value.
